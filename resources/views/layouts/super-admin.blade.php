                            ...
                            <div class="hidden md:flex space-x-1">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.away="open = false" x-cloak class="absolute left-0 mt-2 w-48 dropdown-panel bg-white rounded-lg shadow-lg py-1 border border-gray-200 z-50">
                                        <a href="{{ route('super-admin.shop.products.index') }}" class="dropdown-item text-gray-700 hover:bg-gray-100">{{ __('admin.super_admin.products') }}</a>
                                        <a href="{{ route('super-admin.shop.categories.index') }}" class="dropdown-item text-gray-700 hover:bg-gray-100">{{ __('admin.super_admin.categories') }}</a>
                                        <a href="{{ route('super-admin.shop.orders.index') }}" class="dropdown-item text-gray-700 hover:bg-gray-100">{{ __('admin.super_admin.orders') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
